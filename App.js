...
const Pessoa = ({nome,detalhes,link}) => {
...
const DATA = [
  {
    ...
    "avatar": "https://cdn0.iconfinder.com/data/icons/bold-purple-free-samples/32/User_Avatar_Human_Profile_Face_Circle-512.png",
    "address": {
      "street": "Kulas Light",
      "suite": "Apt. 556",
      "city": "Gwenborough",
...
export default function App() {
  ...
  function meuItem({item}){
    ...
    var infos = "Telefone: " + item.phone + "\n E-mail: " + item.email + "\n Endereco: " + item.address.street + "\n Cidade: " + item.address.city;
    infos = infos + "\n\n Local de trabalho: " + item.company.name
